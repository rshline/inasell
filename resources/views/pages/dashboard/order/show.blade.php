                ...
                <form class="w-full" action="{{ route('dashboard.order.orderitem.store', ['shop'=>$order->shops_id, 'order'=>$order->id, 'product'=>$product->id]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="custom-number-input h-10 w-32">
                        ...
                        <div class="flex flex-row h-10 w-full rounded-lg relative bg-transparent mt-1">
                            ...
                            <input type="number" class="text-center w-full bg-gray-300 font-semibold text-md hover:text-black focus:text-black  md:text-basecursor-default flex items-center text-gray-700  outline-none" name="custom-input-number" value="0"></input>
